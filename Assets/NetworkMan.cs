...
public class NetworkMan : MonoBehaviour
{
    ...
    public class Player{
        public string id;
        public receivedPosition playerposition;        
    }
    ...
    void SpawnPlayers(){
        if (newPlayers.Count > 0){
            foreach (string playerID in newPlayers){
                ...
                currentPlayers[playerID].AddComponent<PlayerMove>();
        ...
        if (initialSetofPlayers.players.Length > 0){
            ...
            foreach (Player player in initialSetofPlayers.players){
                ...
                currentPlayers[player.id].transform.position = new Vector3(player.playerposition.X, player.playerposition.Y, player.playerposition.Z);
                ...
                currentPlayers[player.id].AddComponent<PlayerMove>();
            }
